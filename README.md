...
* 分類ルール：
  ...
  * グルプ２： 漫画，スケッチ，線画、落書き，ちびチャラ，ラブライブ顔，巨乳，大きな尻，足（しかない）の画像など
  * 個人趣味でこの分類ルールを作りました、自分の分類器を作りたい場、[第三節](#jp_3)を参考にしてください.
...
**ハードウェア:** 実行だけなら、月500円の格安VPS（メモリ1G、共有CPU、グラボ無し）でも問題ないです.　自分の分類器を作りたい場、[第三節](jp)を参考にしてください.
